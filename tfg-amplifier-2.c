/* tfg-amplifier-2.c
 * Firmware for the PIC16F1765-I/P for the thin-film-gauge amplifier.
 * 
 ...
 *    2024-11-17 Move the PIC16F1765 onto a dedicated strip-board.
 *
 * This I2C slave device implements the state-table approach shown in
...
int main()
{
    ...
    TRISAbits.TRISA5 = 0; // Output for LED7 on Curiosity board
